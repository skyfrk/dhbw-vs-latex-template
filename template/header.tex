...
\documentclass[hidelinks,12pt]{article}
  ...
  \newcommand{\dhbwPrintBibliography}{%
    \newpage
    \printbibtabular[title=Literaturverzeichnis]\addcontentsline{toc}{section}{Literaturverzeichnis}
  }
  \newcommand{\dhbwPrintListOfAcronyms}[2]{%
    \newpage
    \section*{Abkürzungsverzeichnis}\addcontentsline{toc}{section}{Abkürzungsverzeichnis}
    \begin{acronym}[#1] % spacing between acronym and long name
