...
\documentclass[hidelinks,12pt]{article}
  ...
  \usepackage{etoolbox}
  \providetoggle{dhbw@include@nondisclosurenotice}
  \newcommand{\dhbwProvideNonDisclosureNotice}{\settoggle{dhbw@include@nondisclosurenotice}{true}}
  ...
  \pgfkeys{
    ...
    company/.store in           = \dhbwGetCompany,
